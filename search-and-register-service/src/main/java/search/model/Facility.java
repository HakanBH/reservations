...
public class Facility implements Serializable {
    ...
    @Transient
    private Integer numberOfUserReservations;
    ...
    public Facility(Integer id, Address address, FacilityOwner facilityOwner, FacilityType facilityType, Integer price, String name) {
        this.id = id;
        this.address = address;
        this.facilityOwner = facilityOwner;
        this.facilityType = facilityType;
    ...
    public Integer getNumberOfUserReservations() {
        return numberOfUserReservations;
    }

    public void setNumberOfUserReservations(Integer numberOfUserReservations) {
        this.numberOfUserReservations = numberOfUserReservations;
    }
}
